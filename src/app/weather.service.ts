...
export class WeatherService {
  ...
  updateDayInfoFor(dayNum: number) {
    ...
    this.tpw = {
      ...this.tpw,
      temperature: (dayInfoForDay[0].main.temp),
       pressure: (dayInfoForDay[0].main.pressure),
       windSpeed:(dayInfoForDay[0].main.humidity)
        };
  ...
  temperatureInCelcius: Math.ceil(dayInfoForDay[0].main.temp)-270,
  ...
  fetchWeatherInfo(cityName: string) {
      ...
      .subscribe((rsp) => {
        ...
        this.tpw = {
         temperature: (data.list[0].main.temp),
          ...
          windSpeed:(data.list[0].main.humidity)
           };
    ...
    temperatureInCelcius: Math.ceil(data.list[0].main.temp)-270,
    temperatureInFahrenheit: (((Math.ceil(data.list[0].main.temp)-273)*9/5)+32)
              };
              //console.log(this.temperature.temperatureInFahrenheit);
            
           //console.log(this.tpw.temperature);
